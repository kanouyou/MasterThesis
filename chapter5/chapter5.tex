\chapter{Thermal stability and quench protection of superconducting solenoids}
...
Due to the joule heat $I^2(t)R(T)$, a relation between the time dependence of the current after quench and the maximum temperature can be established.
...
CS1 coils have 9 layers and 270 turns totally, and aluminium strips with RRR of 2000 are inserted into each layer.
 \begin{figure}[H]
   ...
   \label{4geo}
  \end{figure}
Here it is approached to 270 conductors along the axis 19 layers (conductor + strip) along the radius.
...
\begin{figure}[H]
 \centering
 \includegraphics[scale=0.70]{chapter5/fig/flux.eps}
 \caption{Neutron flux for 90-day operation.}
 \label{neutr}
\end{figure}
\begin{figure}[H]
 \centering
 \includegraphics[scale=0.70]{chapter5/fig/heat.eps}
 \caption{Heat load of CS1-a and CS1-b coils.}
 \label{heatload}
\end{figure}

\subsubsection{Thermal stability and quench}
...
\begin{figure}[H]
 \begin{subfigure}{0.3\textwidth}
  \centering
  \includegraphics[scale=0.4]{chapter5/fig/CS1a.pdf}
 \end{subfigure}
 \hspace{0.2\textwidth}
 \begin{subfigure}{0.3\textwidth}
  \centering
  \includegraphics[scale=0.4]{chapter5/fig/SimQuench.eps}
 \end{subfigure}
