...
%   \caption{\it The peak of $^{197}$Au decay on the diode downstream.}
%   \label{3nipeak}
%  \end{figure}
...
Compared with the case of room temperature, 0.33 V is increased during the cooling.
 \begin{figure}[H]
  \centering
  \includegraphics[scale=0.28]{chapter4/fig/cryotemp.pdf}
...
This insulation tape shown in figure~\ref{3stur} is made of polyimide film covered by boron free glass with BT and epoxy resin to enhance the mechanical property under the high radiation environment.
 \begin{figure}[H]
  ...
  %\caption{\it The structure of pre-preg tape.}
  \label{3stur}
  \end{subfigure}
  \hspace{0.2\textwidth}
  \begin{subfigure}{0.3\textwidth}
  ...
  %\caption{\it Tensile test for pre-preg tape.}
  \label{3break}
  \end{subfigure}
...
\begin{figure}[H]
 ...
 \label{3yield}
\end{figure}
To ensure what kinds of particle hit the superconducting coils, the simualtion is taken by PHITS and its yield is shown in figure~\ref{3yield}.
